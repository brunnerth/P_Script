...
#region File Recovery Data (DO NOT MODIFY)
<#RecoveryData:
#>
#endregion
	#----------------------------------------------
	#region Import the Assemblies
	#----------------------------------------------
	...
	$formChildForm_Load={
			...
			$labelGestionTion.Text = " $ramUsed / $totalRam ";
	...
	for ($i = 0; $i -lt $enableOrDisable.Count; $i++)
	{
		...
		$checkboxOnOff.Add_CheckedChanged({
				...
				if ($this.Checked -eq $true)
				{
					...
					$label2.Text = $this.Name, $this.Tag;
				}
				else
				{
	...
	$formChildForm.ClientSize = '992, 550'
	...
	$labelLancerAuDémarrage.Location = '625, 339'
	...
	$labelUtilisationDeLaRAM.Location = '625, 9'
